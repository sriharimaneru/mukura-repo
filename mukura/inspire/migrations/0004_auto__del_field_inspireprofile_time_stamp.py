...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InspireProfile.time_stamp'
        db.delete_column('inspire_inspireprofile', 'time_stamp')


    def backwards(self, orm):
        # Adding field 'InspireProfile.time_stamp'
        db.add_column('inspire_inspireprofile', 'time_stamp',
